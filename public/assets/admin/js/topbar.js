 ...
 * topbar.js
 * ---------------------------------------------------------
 * Render bagian header/topbar: tombol hamburger (mobile),
 * breadcrumb, search command (⌘K), dropdown notifikasi,
 * dropdown pesan, tombol tema, dan dropdown akun.
 */

/**
 * Ubah string breadcrumb "Home | Dashboard" jadi HTML span
 * dipisah tanda ">" kecuali item terakhir yang diberi class "current".
 */
...
/**
 * Render seluruh <header class="d-topbar">.
 * @param {string} crumbsString - contoh: "Home | Dashboard"
 */
